# Reference : https://github.com/rootpine/Bicubic-interpolation
"""
Bicubic-interpolation for downsampling the training images.
"""
import cv2
import numpy as np
import math
...
# Read image
image_root = '../datasets/training_hr_images/training_hr_images'
image_save_root = '../datasets/training_hr_images/training_lr_bicubic_images_s3/'
...
for image in os.listdir(image_root):
    ...
    for r in ratios:
        ...
        img_save_name = image
        cv2.imwrite(image_save_root+img_save_name, dst)
